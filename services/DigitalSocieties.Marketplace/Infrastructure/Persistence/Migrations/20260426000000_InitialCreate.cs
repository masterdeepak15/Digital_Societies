    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                base_rate_amount  = table.Column<decimal>(precision: 18, scale: 2, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                quoted_amount    = table.Column<decimal>(precision: 18, scale: 2, nullable: false),
                quoted_currency  = table.Column<string>(maxLength: 3, nullable: false, defaultValue: "INR"),
                final_amount     = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
